...
vec3 curlNoise(vec3 p)
{
  ...
  vec3 p_x0 = snoisVec3(p - dx);
  vec3 p_x1 = snoisVec3(p + dx);
  vec3 p_y0 = snoisVec3(p - dy);
  vec3 p_y1 = snoisVec3(p + dy);
  vec3 p_z0 = snoisVec3(p - dz);
  vec3 p_z1 = snoisVec3(p + dz);
